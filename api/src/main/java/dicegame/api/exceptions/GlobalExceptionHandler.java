...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> superHeroNotFoundException(PlayerNotFoundException ex, WebRequest request) {
    ...
    public ResponseEntity<ErrorMessage> superHeroAlreadyExistException(PlayerAlreadyExistException ex, WebRequest request) {
        ErrorMessage message = new ErrorMessage(
